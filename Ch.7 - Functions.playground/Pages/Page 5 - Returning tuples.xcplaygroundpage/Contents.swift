...
// A function can return a tuple, that is, a compound value. 
// Only a tuple of two or more values can contain named values.

// Returns a tuple valud and suit, both of type string
